...
public class BubbleChartDataEntry extends ChartDataEntry {
	...
	public native BubbleChartDataEntry initWithXYIcon(double x, double y,
			UIImage icon);

	@Generated
	@Selector("initWithX:y:icon:data:")
	public native BubbleChartDataEntry initWithXYIconData(double x, double y,
	...
	public native BubbleChartDataEntry initWithXYSizeIcon(double x, double y,
			@NFloat double size, UIImage icon);

	@Generated
	@Selector("initWithX:y:size:icon:data:")
	public native BubbleChartDataEntry initWithXYSizeIconData(double x,
			double y, @NFloat double size, UIImage icon,
			@Mapped(ObjCObjectMapper.class) Object data);
	...
	public native BubbleChartDataEntry initWithYIconData(double y,
			UIImage icon, @Mapped(ObjCObjectMapper.class) Object data);
