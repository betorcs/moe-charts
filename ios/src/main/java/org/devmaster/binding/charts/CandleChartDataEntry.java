...
public class CandleChartDataEntry extends ChartDataEntry {
	...
	public native CandleChartDataEntry initWithXShadowHShadowLOpenCloseIcon(
			double x, double shadowH, double shadowL, double open,
			double close, UIImage icon);

	@Generated
	@Selector("initWithX:shadowH:shadowL:open:close:icon:data:")
	public native CandleChartDataEntry initWithXShadowHShadowLOpenCloseIconData(
			double x, double shadowH, double shadowL, double open,
			double close, UIImage icon,
	...
	public native CandleChartDataEntry initWithXYIcon(double x, double y,
			UIImage icon);

	@Generated
	@Selector("initWithX:y:icon:data:")
	public native CandleChartDataEntry initWithXYIconData(double x, double y,
	...
	public native CandleChartDataEntry initWithYIconData(double y,
			UIImage icon, @Mapped(ObjCObjectMapper.class) Object data);
