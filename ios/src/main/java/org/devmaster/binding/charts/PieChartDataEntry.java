...
public class PieChartDataEntry extends ChartDataEntry {
	...
	public native PieChartDataEntry initWithValueIconData(double value,
	...
	public native PieChartDataEntry initWithValueLabelIcon(double value,
			String label, UIImage icon);

	@Generated
	@Selector("initWithValue:label:icon:data:")
	public native PieChartDataEntry initWithValueLabelIconData(double value,
			String label, UIImage icon,
			@Mapped(ObjCObjectMapper.class) Object data);
	...
	public native PieChartDataEntry initWithXYIcon(double x, double y,
			UIImage icon);

	@Generated
	@Selector("initWithX:y:icon:data:")
	public native PieChartDataEntry initWithXYIconData(double x, double y,
			UIImage icon, @Mapped(ObjCObjectMapper.class) Object data);
