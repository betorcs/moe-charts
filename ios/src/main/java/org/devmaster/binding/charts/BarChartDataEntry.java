...
public class BarChartDataEntry extends ChartDataEntry {
	...
	public native BarChartDataEntry initWithXYIcon(double x, double y,
			UIImage icon);

	@Generated
	@Selector("initWithX:y:icon:data:")
	public native BarChartDataEntry initWithXYIconData(double x, double y,
	...
	public native BarChartDataEntry initWithXYValuesData(double x,
			NSArray<? extends NSNumber> yValues,
			@Mapped(ObjCObjectMapper.class) Object data);

	@Generated
	@Selector("initWithX:yValues:icon:")
	public native BarChartDataEntry initWithXYValuesIcon(double x,
			NSArray<? extends NSNumber> yValues, UIImage icon);

	@Generated
	@Selector("initWithX:yValues:icon:data:")
	public native BarChartDataEntry initWithXYValuesIconData(double x,
			NSArray<? extends NSNumber> yValues, UIImage icon,
			@Mapped(ObjCObjectMapper.class) Object data);
